...
const ChatBotApp = ({ onGoBack, chats, setChats, activeChat, setActiveChat, onNewChat }) => {
    ...
    const sendMessage = async () => {
        ...
        if (!activeChat) {
            ...
            localStorage.setItem(activeChat, JSON.stringify(updatedChatsWithResponse))
            setIsTyping(false);
    ...
    useEffect(() => {
        chatEndRef.current?.scrollIntoView({ bahvior: 'smooth' })
    }, [messages])
    ...
    <div className="chat-app">
        ...
        <div className="chat-window">
            ...
            <form className='msg-form' onSubmit={(e) => e.preventDefault()}>
                <i className="fas fa-solid fa-smile emoji" onClick={() => setShowEmojiPicker((prev) => !prev)}></i>
                {showEmojiPicker && (
